...
<footer className="p-16 bg-[#e8f8fa] mr-1">
    <div className='flex flex-row justify-between items-start md:flex-wrap'>
    <div className="ml-16 mr-10 md:w-screen md:ml-0">
    ...
    <div className='flex flex-col justify-start items-start md:w-3/6'>
        <p className='text-[#4f5665] font-latoBold text-base mb-1'>Products</p>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>Solutions</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>Dashboard</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm'>Mobile App</Link>
    </div>
    <div className='flex flex-col justify-start items-start md:w-3/6'>
        <p className='text-[#4f5665] font-latoBold text-base mb-1'>Integrations</p>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>Shopify</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>WooCommerce</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm'>Custom APIs</Link>
    </div>
    <div className='flex flex-col justify-start items-start md:w-3/6 md:mt-4'>
        <p className='text-[#4f5665] font-latoBold text-base mb-1'>Businesses</p>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>Businesses</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm'>Use Cases</Link>
    </div>
    <div className='flex flex-col justify-start items-start md:w-3/6 md:mt-4'>
        <p className='text-[#4f5665] font-latoBold text-base mb-1'>Company</p>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>About us</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>Careers</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>Pricing</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm mb-2'>FAQ</Link>
        <Link to="" className='text-[#4f5665] font-latoBold text-sm'>Help Center</Link>
    </div>
    <div className='flex flex-col justify-start items-start'>
        <Link to="" className='text-[#4f5665] font-latoBold text-base border-b md:mt-5'>Track Shipment</Link>
    </div>
    </div>
</footer>
